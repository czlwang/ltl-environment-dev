...
CRAFT_LTL_GRAMMAR = """
    ...
    EXPR -> TOP_G | TOP_F | TOP_U | S OP_2 S | OP_1 S
    PRED -> LPAREN TERM OP_2 TERM RPAREN | OP_1 TERM | TERM
    TOP_G -> EVENTUALLY GLOBAL S | EVENTUALLY GLOBAL PRED
    TOP_F -> EVENTUALLY S | EVENTUALLY PRED
    TOP_U -> LPAREN TOP_F RPAREN UNTIL S  | LPAREN TOP_F RPAREN UNTIL PRED
    UNTIL -> 'U'
    GLOBAL -> 'G'
    EVENTUALLY -> 'F'
    OP_1 -> '!'

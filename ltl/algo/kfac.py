...
class KFACOptimizer(optim.Optimizer):
    def __init__(self,
        ...
        def split_bias(module):
            for mname, child in module.named_children():
                if hasattr(child, 'bias') and child.bias is not None and child.bias is not True:
    ...
    def _save_input(self, module, input):
        if torch.is_grad_enabled() and self.steps % self.Ts == 0:
            ...
            # Initialize buffers
            if self.steps == 0 or module not in self.m_aa.keys():
    ...
    def _save_grad_output(self, module, grad_input, grad_output):
        ...
        if self.acc_stats:
            ...
            # Initialize buffers
            if self.steps == 0 or module not in self.m_gg.keys():
